  ...
  return (
    <div className="new-sem-tent1">
        <div className="new-ser-title">
            <p>天蕾SEO服务介绍</p>
            <span>互联网新时代，SEO就把你难住了？</span> </div>
        <div className="index-1200 index-over">
            <div className="new-sem-tent1-left">
                <p><span>SEO服务介绍</span></p>
                <span>天蕾拥有先进的SEM推广理念，各大搜索引擎推广的专业经验，秉承精细专注的经营理念，专业的分析服务，强大的技术支持，为客户带来以提高投资回报率(ROI)为核心目标的搜索引擎营销全面管理和优化服务。</span>
                <div>天蕾最新推出SEO解决方案，一次性为您解决品牌呈现难题！</div>
                <a href={baiduQiao} target="_blank">免费获取方案</a>
            </div>
            <div className="new-sem-tent1-right"> <img src="/home/static/images/seo/3.png" alt=""/> </div>
        </div>
    </div>
  )
}